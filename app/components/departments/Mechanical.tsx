...
const Mechanical= () => {
  ...
  const links = [
    ...
    { title: "Electrical & Electronics Engineering", count: "03" },
        { title: "Civil Engineering", count: "04" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12  ">
          ...
          <div className="lg:col-span-8 flex flex-col gap-10 max-w-3xl">
            ...
            <p className="pl-3 text-black leading-relaxed">
                The Department of Mechanical Engineering at DIGIT College of Engineering stands as the powerhouse of technical expertise and creative problem-solving. Our program is built on a foundation of classical mechanics, thermodynamics, and fluid dynamics, yet it constantly evolves to meet the demands of the modern world. We provide students with a holistic learning environment where they transition from understanding the physics of energy to designing complex machines. With access to advanced workshops and CAD/CAM simulation centers, our students develop the precision and technical depth required to excel in diverse sectors, from heavy manufacturing and power plants to the intricate world of precision tooling.
            </p>
            ...
            <p className="text-black leading-relaxed">
                In an era of rapid industrial transformation, the Mechanical Engineering branch at Digit College focuses heavily on the integration of Mechatronics and Robotics. We prepare our graduates to lead the charge in Industry 4.0 by blending traditional machine design with automated control systems and artificial intelligence. Students engage in high-level research involving sustainable energy systems, aerospace components, and automotive engineering, ensuring they are equipped to build the efficient, eco-friendly technologies of tomorrow. By emphasizing both theoretical excellence and hands-on fabrication, we ensure our engineers are not just thinkers, but doers who drive global progress.
            </p>
          </div>
