...
const ElectricElectronicHero: React.FC = () => {
  return (
    <section className="relative h-[40vh] w-full overflow-hidden bg-[var(--color-theme)]">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('/departments/eeehero.jpg')`, 
        }}
      >
      ...
      <div className="relative h-full max-w-7xl mx-auto px-8 flex flex-col justify-center">
        <div className="max-w-xl border-l-2 border-[var(--color-theme-2)]/50 pl-6">
          ...
          <h2 className="text-sm md:text-base font-bold text-[var(--color-theme-2)] uppercase tracking-[0.3em] mb-3">
           Electrical Electronics <span className="text-[var(--color-footer-text)]">Engineering</span>
          </h2>
          ...
          <div className="relative group">
           ...
           EEE is the engineering branch that designs and manages everything from massive power grids to microscopic electronic circuits.
</p>
          </div>
...
export default ElectricElectronicHero;