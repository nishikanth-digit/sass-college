...
const CyberSecurityHero: React.FC = () => {
  return (
    <section className="relative h-[40vh] w-full overflow-hidden bg-[var(--color-theme)]">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('/departments/cybersecurityhero.jpg')`, 
        }}
      >
      ...
      <div className="relative h-full max-w-7xl mx-auto px-8 flex flex-col justify-center">
        <div className="max-w-xl border-l-2 border-[var(--color-theme-2)]/50 pl-6">
          ...
          Cyber  <span className="text-[var(--color-footer-text)]">Security</span>
          </h2>
...
Cybersecurity is the essential practice of protecting systems, networks, and programs from digital attacks.
            </p>
          </div>
