...
const InternetofThings = () => {
  ...
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12  ">
          ...
          <div className="lg:col-span-8 flex flex-col gap-10 max-w-3xl">
            ...
            <header className="space-y-6">
             ...
             The Impact of Industrial IoT on Modern Business
                </span>
              </h1>
            </header>
    ...
    The Internet of Things (IoT) represents a massive shift in how we interact with the physical world, moving beyond computers and smartphones to a reality where everyday objects are "awake" and communicating. At its core, IoT is a network of physical objects embedded with sensors, software, and processing power that allows them to connect and exchange data with other devices over the internet.
            </p>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 shadow-xl group">
              ...
              <img
                src="/departments/internetofthings.png"
...
This connectivity transforms a standard object—like a city streetlight or a residential thermostat—into an intelligent tool capable of gathering real-time information. By analyzing this data, systems can automate tasks, such as adjusting a building’s temperature based on occupancy or alerting a factory manager to a failing part before a breakdown occurs. Ultimately, IoT isn't just about "smart gadgets"; it is about creating a seamless bridge between the digital and physical realms to improve efficiency, safety, and sustainability on a global scale.
            </p>
          </div>
