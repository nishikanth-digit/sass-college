...
style={{
  backgroundImage: `url('/facilities/transporthero.jpg')`,
      ...
      <div className="relative h-full max-w-7xl mx-auto px-8 flex flex-col justify-center">
        <div className="max-w-xl border-l-2 border-[var(--color-theme-2)]/50 pl-6">
          ...
          <h2 className="text-sm md:text-base font-bold text-[var(--color-theme-2)] uppercase tracking-[0.3em] mb-3">
           College<span className="text-[var(--color-footer-text)]">Transport</span>
          </h2>
          ...
          <div className="relative group">
            ...
            <p className="relative text-base md:text-lg text-[var(--color-footer-text)]/80 leading-relaxed font-medium italic"> Seamless travel connecting every corner of the city to our campus. <br />
              Experience safe, punctual, and reliable transit, delivered with precision.
          </p>
          </div>
